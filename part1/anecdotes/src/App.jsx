...
const App = () => {
  ...
  // const vote = () => setVotes(votes[selected] + 1)
  const vote = () => {
    // const votestemp = [...votes.slice(0, selected), votes[selected] + 1, ...votes.slice(selected, anecdotes.length)]
    const votestemp = [...votes]
    votestemp[selected] += 1
    return setVotes(votestemp)
  }
